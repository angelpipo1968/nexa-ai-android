...
object NexaStrings {
    ...
    private val spanish = mapOf(
        ...
        "voice_mode_off" to "Modo conversación desactivado", "voice_mode_hint" to "Habla libremente, NEXA te escucha",
        "voice_mode_listening" to "Escuchando...", "voice_mode_thinking" to "Pensando...",
        "voice_mode_speaking" to "Hablando...", "tap_to_stop" to "Toca para detener"
    )
    ...
    private val english = mapOf(
        ...
        "voice_mode_off" to "Voice mode deactivated", "voice_mode_hint" to "Speak freely, NEXA is listening",
        "voice_mode_listening" to "Listening...", "voice_mode_thinking" to "Thinking...",
        "voice_mode_speaking" to "Speaking...", "tap_to_stop" to "Tap to stop"
    )
}
