...
-keep class ai.nexa.core.NexaSdk { *; }
-keep class ai.nexa.core.LlmWrapper { *; }
-keep class ai.nexa.core.VlmWrapper { *; }
-keep class ai.nexa.core.LlmCreateInput { *; }
-keep class ai.nexa.core.VlmCreateInput { *; }
-keep class ai.nexa.core.ModelConfig { *; }
-keep class ai.nexa.core.GenerationConfig { *; }

# ─── Vision Repository ────────────────────────────────────
-keep class com.nexa.ai.data.VisionRepository { *; }
-keep class com.nexa.ai.data.VisionRepository$* { *; }
-keep class com.nexa.ai.ml.OnDeviceInferenceManager { *; }
-keep class com.nexa.ai.ml.OnDeviceInferenceManager$* { *; }
-keep class com.nexa.ai.ml.SmartRoutingManager { *; }
-keep class com.nexa.ai.ml.SmartRoutingManager$* { *; }
